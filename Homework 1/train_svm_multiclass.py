...
if __name__ == '__main__':
  ...
  # default setting
  # clf = SVC(probability=True, gamma='auto', cache_size=2000, decision_function_shape = 'ovr', kernel='rbf')
  # new setting
  clf = SVC(probability=True, gamma='scale', cache_size=2000, decision_function_shape = 'ovr', kernel='poly', class_weight = 'balanced')
